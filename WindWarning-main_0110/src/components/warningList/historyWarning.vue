      ...
      <el-row :gutter="5">
        ...
        <el-col :span="4">
          <el-form-item label="预警等级：" prop="warning_level">
            <el-select v-model="warning_level" placeholder="全部" value-key="id" style="--el-input-text-color: white">
              <el-option :label="'全部'" :value="''"></el-option>
              <el-option
        ...
        <el-col :span="4">
          <el-form-item label="系统分类：" prop="modules_id">
            <el-select v-model="module_id" placeholder="全部" value-key="id" style="--el-input-text-color: white">
              <el-option :label="'全部'" :value="''"></el-option>
