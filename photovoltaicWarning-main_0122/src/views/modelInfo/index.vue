  ...
  <div class="container">
    <el-form label-width="120px">
      <el-row :gutter="5">
        ...
        <!-- 风场 -->
        <el-col :span="4">
          <el-form-item label="场站：" prop="windfarm_id">
        ...
        <!-- 光伏机器 -->
        <el-col :span="4">
          <el-form-item label="光伏机器：" prop="turbine_id">
    ...
    <el-table :data="modelList">
      ...
      <el-table-column prop="turbineNumber" label="光伏机器" align="center"></el-table-column>
