...
const processedReportList = computed(() => {
  return reportList.value.map((report) => {
    ...
    // 如果找到匹配的光伏机器，添加turbineName
    return {
      ...report,
      turbineName: matchedTurbine ? matchedTurbine.turbineName : '未知光伏机器'
    }
  })
})
//获取通知信息
...
const back = () => {
  router.push('/photovoltaicWarning/todo')
}
    ...
    <div class="main">
      <div class="info">
        <div class="info-text">
          ...
          <span class="span-name" style="width: 90px;">光伏机器名称</span>
      ...
      <el-table :data="processedReportList">
        <el-table-column prop="turbineName" label="光伏机器名称" align="center"></el-table-column>
