...
import { getModel, predict, stopPredict,getCompany,getPvFarmList,getAlg,Delete } from '@/api/model'
...
const getModelData = async () => {
  try {
    ...
    // inverterList.value.forEach((inverter) => {
    //   const pvFarm = pvFarmList.value.find((farm) => farm.pvFarmId === inverter.pvFarmId)
    //   if (pvFarm) {
    //     inverter.inverterName = `${pvFarm.pvFarmName}-${inverter.inverterName}`
    //   }
    // })
