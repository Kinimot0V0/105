...
const confirm = async () => {
  try {
    ...
    if (alertPvowSize.value) requestData.alertPvowSize = parseInt(alertPvowSize.value)
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="6">
            <el-form-item label="预警窗口大小" prop="modelVersion">
              <el-input v-model="alertPvowSize" placeholder="请输入预警窗口大小"></el-input>
            </el-form-item>
          </el-col>  
          <!-- 自定义参数复选框 -->
          <el-col :span="6">
