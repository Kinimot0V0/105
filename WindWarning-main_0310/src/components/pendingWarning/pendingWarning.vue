...
const isReportDisabled = computed(() => {
  const selected = selectedExpandedRows.value;
  return selected.length === 0 || !selected.every(row => row.warningLevel === 2 && (row.warningStatus === 0 || row.warningStatus === 1));
});
      ...
      <el-table-column type="expand">
          <template #default="{ row }">
            ...
            <el-table
              ...
              <el-table-column prop="" label="预警详情" align="center" width="140px"></el-table-column>
