...
import { getTurbineInfo,getTrendData,getFarmInfo } from '@/api/warningDetail'
...
const getPointInfo = async () => {
  try {
    const params = { turbineId: props.turbineId }
    ...
    const responseFarm = await getFarmInfo(params)
