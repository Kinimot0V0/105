...
const look = (turbineId,warningDescription,warningLevel,startTime,endTime,warningStatus,turbineName) =>{
    ...
    <el-table :data="warningList">
      ...
      <el-table-column prop="" label="详情" align="center" width="150px">
        <template #default="scope">
          ...
          scope.row.warningLevel,scope.row.startTime,scope.row.endTime,scope.row.warningStatus,scope.row.turbineName)">查看</el-link>
        </template>
      </el-table-column>
    </el-table>
