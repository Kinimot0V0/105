    ...
    <el-table :data="reportList">
      <el-table-column label="风机名称" align="center">
        <template #default="scope">
          {{ scope.row.windFarmName }}&nbsp;&nbsp;{{ scope.row.turbineName }}
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" width="240px" align="center" v-if="showButton">
        <template #default="scope">
          <el-link type="primary" @click="handleReport(scope.row.reportId,scope.row.windFarmName,scope.row.windFarmId,scope.row.turbineId)"> 处理 </el-link>
        </template>
      </el-table-column>
    </el-table>
