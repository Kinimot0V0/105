...
<template>
  <div class="container1">
    ...
    <div class="info-text">
      ...
      <span class="span-value">{{ pvFarmName }}</span>
      <span class="span-name">设备</span>
      <span class="span-value" style="width: 220px">{{ props.deviceName }}</span>
      ...
      <el-button class="buttonLike" style="width: 60px; margin-left: 20px">{{
        levelMap[props.warningLevel]?.label
      }}</el-button>
        ...
        <div class="otherChart">
          ...
          <template v-if="currentPicType === 2">
            ...
            <div v-if="trendPicData.length" class="trend-scroll">
              <div v-for="(chart, idx) in trendPicData" :key="idx" class="trend-wrapper">
            ...
            <div v-if="thresholdPicData.length" class="trend-scroll">
              <div v-for="(chart, idx) in thresholdPicData" :key="'t_' + idx" class="trend-wrapper">
                <div class="chart-title">{{ chart.title }}</div>
            ...
            <!-- 没有数据时的提示 -->
            <div v-if="!trendPicData.length && !thresholdPicData.length" class="no-data">正在加载图表数据...</div>
          </template>
        </div>
      </div>
        ...
        <div class="trendChart">
          <div class="trendInfo">
            ...
            <div class="time">
              ...
              <el-button @click="setQuickTime('1day')" type="primary"> 最近1天 </el-button>
              <el-button @click="setQuickTime('7day')" type="primary"> 最近7天 </el-button>
            </div>
          </div>
          <div class="chart">
