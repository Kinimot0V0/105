...
const getWarningData = async () => {
  try {
    ...
    // console.log('/ews/warning/getWarnList_params:', params)
    const response = await getWarnList(params)
    // console.log('/ews/warning/getWarnList返回结果:', response)
...
const getTurbineWarnData = async () => {
  try {
    ...
    // console.log('/ews/warning/queryTurbineWarnMatrix_params:', params)
    const response = await getTurbineWarnList(params)
    // console.log('/ews/warning/queryTurbineWarnMatrix返回结果:', response)
