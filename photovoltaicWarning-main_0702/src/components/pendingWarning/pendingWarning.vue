...
const pvFarmId = route.query.pvFarmId
const pvFarmName = route.query.pvFarmName
...
const look = (warningDescription, warningLevel, startTime, endTime, warningStatus, warningId) => {
  ...
  <div class="container">
    ...
    <div class="main">
      <div class="info">
        <div class="info-text">
          ...
          <span class="span-value" style="width: 250px">{{ deviceName }}</span>
        </div>
      ...
      >
        <el-table-column type="expand">
          <template #default="{ row }">
            ...
            >
              ...
              <el-table-column prop="deviceName" label="设备名称" width="320px" align="center"></el-table-column>
        ...
        <el-table-column prop="deviceName" label="设备名称" width="700px" align="center"></el-table-column>
        <el-table-column prop="warningDescription" label="预警信息" align="center"></el-table-column>
      </el-table>
    </div>
    <!-- 弹窗 -->
    ...
    <el-dialog title="通知" v-model="reportDialogVisible" width="60%">
      <pendingReport
        ...
        :dialogData="dialogData"
        :pvFarmId="Number(pvFarmId)"
        :pvFarmName="pvFarmName"
