        ...
        switch (node.id) {
          case '1':
            return {
              ...
              data: {
                ...node.data,
                count1: turbine.warningLevel1waitDoneSum,
                count2: turbine.warningLevel2waitDoneSum
              }
            }
          case '2':
            return {
              ...
              data: {
                ...node.data,
                count1: turbine.warningLevel1waitHangUpSum,
                count2: turbine.warningLevel2waitHangUpSum
              }
            }
          case '5':
            return {
              ...
              data: {
                ...node.data,
                count1: turbine.warningLevel1waitCloseWaitSum,
                count2: turbine.warningLevel2waitCloseWaitSum
              }
            }
          case '3':
            return {
